...
export class UiStore {
  ...
  @observable tribeInfo: { [k: string]: any } = null;
  @observable tribeInfoParams: { [k: string]: any } = null;
  @action setTribeInfo(chat, params) {
    (this.tribeInfo = chat), (this.tribeInfoParams = params);
  }
  ...
  @observable tribesSaveParams: { [k: string]: any } = null;
  @action setTribesSaveParams(o) {
    this.tribesSaveParams = o;
  }
