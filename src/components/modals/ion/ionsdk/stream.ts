...
export class Stream extends MediaStream {
  ...
  public addTrack(t,s?){
    return this.addTrack(t,s)
  }
  public removeTrack(t){
    return this.removeTrack(t)
  }
  public onaddtrack
  ...
  public clone
  public getTrackById
  public addEventListener(a){
    return this.onaddtrack(a)
  }
  public removeEventListener(arg){
    return this.removeEventListener(arg)
  }
...
export class LocalStream extends Stream {
  ...
  async publish(rid: string) {
    ...
    console.log('Created offer => %o', offer);
