...
//NODE1 SENDS AN IMAGE TO NODE2
    ...
    if(price){
      ...
      const [n2contactP2, n1contactP2] = await getContacts(t, node2, node1)
      ...
      if(tribe){
        ...
        const sharedChat = chats.find(chat => h.arraysEqual(chat.contact_ids, [1, parseInt(n1contactP2.id)]))
      ...
      t.true(purchased.success, "purchase message should be posted")
      //await post
      await h.sleep(1000)
