...
//NODE2 SENDS AN IMAGE TO NODE1
    ...
    const upload2 = await meme.uploadMeme(fileBase64, typ, host, token, filename, isPublic)
    t.truthy(upload2, "meme should have been uploaded")
    t.truthy(upload2.media_key, "upload should have media key")
    t.truthy(upload2.muid, "upload should have muid")
    ...
    //extract node1 id
    var node1id = node1contact.id

    //encrypt media_key with node1 contact_key
    const encrypted_media_key2 = rsa.encrypt(node1contact.contact_key, upload2.media_key)
    ...
    const i2 = {
        ...
        chat_id: null,
        muid: upload2.muid,
        media_key_map: {[node1contact.id]: encrypted_media_key2},
    ...
    const img2 = await http.post(node2.ip+'/attachment', f.makeArgs(node2, i2))
    //make sure msg exists
    t.truthy(img2, "sent image should exist")
    ...
    //extract the last message sent to node2
    const lastMessage3 = res.response.new_messages[res.response.new_messages.length-1]
    console.log("LAST MESSAGE 3 === ", lastMessage3)
    //get media key from message
    const node1MediaKey2 = lastMessage3.media_key

    const decryptMediaKey2 = rsa.decrypt(node1.privkey, node1MediaKey2)

    //get media token
    var token = await getToken(t, node1)

    const url2 = `https://memes.sphinx.chat/file/${lastMessage3.media_token}`

    const res4 = await fetch(url2, {headers: {Authorization: `Bearer ${token}`}})
    console.log("RES3 === ",res4)
    const blob2 = await res4.buffer()

    console.log("DECRYPT MEDIA KEY === ", decryptMediaKey2, blob2.length)
    //media_key needs to be decrypted with your private key
    const dec2 = RNCryptor.Decrypt(blob2.toString("base64"), decryptMediaKey2)
    // const b64 = dec.toString('base64')
    console.log("DEC === ", dec2)
    // //check equality b64 to b64    
    t.true(dec2.toString("base64") === "")


//NODE1 SENDS AN IMAGE TO NODE2
var token = await getToken(t, node1)
var host = "memes.sphinx.chat"
var fileBase64 = "data:image/jpeg;base64,"
var typ = "image/jpg"
var filename = "Image.jpg"
var isPublic = false
...
//create node2 contact object from node1 perspective
node2contact = res.response.contacts.find(contact => contact.public_key === node2.pubkey)
//extract node2 id
node2id = node2contact.id

//encrypt media_key with node2 contact_key
const encrypted_media_key = rsa.encrypt(node2contact.contact_key, upload.media_key)
...
const i = {
    ...
    chat_id: null,
    muid: upload.muid,
    media_key_map: {[node2contact.id]: encrypted_media_key},
    media_type: 'image/jpg',
    text: '',
    amount: 0,
    price: 0
...
//send image from node1 to node2
const img = await http.post(node1.ip+'/attachment', f.makeArgs(node1, i))
