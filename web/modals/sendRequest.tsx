    ...
    return (
      ...
      >
        <RequestContent bg={theme.bg}>
          ...
          >
            <ClearRoundedIcon
              onClick={sendRequestModalHandler}
              style={{ color: "#4f565d", width: 25, height: 25 }}
            />
            <div style={{ paddingTop: 5 }}>
              {mode === "Request" ? "REQUEST AMOUNT" : "SEND PAYMENT"}
            </div>
    ...
    >
      <Content bg={theme.bg}>
        <RowButton bg={theme.bg} onClick={() => setMode(`Request`)}>
          <CallReceivedIcon
            style={{ color: "white", marginRight: 25, fontSize: 30 }}
          />
          Request
        </RowButton>
