    ...
    <Mid>
      <Button variant="contained" size="medium" color="primary"
        style={{width:'100%',position:'relative'}}
          ...
          AUDIO
        <MicIcon style={{fontSize:18,color:'white',position:'absolute',right:10,top:10}} />
      </Button>
      {!audioOnly && <Button variant="contained" size="medium" color="secondary"
        style={{width:'100%',position:'relative',color:'white',marginTop:8}}
        onClick={openCall}>
          VIDEO
        <VideoCallIcon style={{fontSize:18,color:'white',position:'absolute',right:10,top:10}} />
      </Button>}
    </Mid>
    <Bottom>
